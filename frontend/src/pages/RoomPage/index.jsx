...
const RoomPage = ({ user, socket, users }) => {
    ...
    return (
        <div className="row">
            ...
            {user?.presenter && (
                <div className="col-md-10 mx-auto px-4 mt-3 mb-1 d-flex align-items-center justify-content-center">
                    <div className="d-flex col-md-4 justify-content-between gap-5">
